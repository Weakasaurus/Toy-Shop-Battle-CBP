...
export default function ShopHub() {
  ...
  // 🔒 Lock if submitted and not released
  useEffect(() => {
    const quarters = ["1", "2", "3", "4"];
    const locked = quarters.some(q => {
      const submitted =
  ...
  const releasedQuarters = ["1","2","3"].filter(q =>
    localStorage.getItem(`Q${q}-released`) === "true"
  );
      ...
      <div style={styles.container}>
        ...
        <div style={styles.layout}>
          ...
          <div style={styles.right}>
            <img src={shop.founderImage} alt="" style={styles.image} />
